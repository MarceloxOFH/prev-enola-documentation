...
monitor = Tracking(
    ...
    channel_id="code",        # Channel ID (e.g., 'web', 'mobile')
...
monitor.close_step_others(
    step=step_generic,
    successfull=True,  # True if Success, if not then False
...
```
#### **Register Errors or Warnings (If Any)**
